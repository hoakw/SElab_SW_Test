...
token_stream tstream_ptr;
{
	  ...
	  switch(next_st) 
            { 
                 ...
                 case 11 :
                 case 13 :
		 case 12 : /* added code */   // Fault version2 -JUNE 
                 case 16 : ch=get_char(tstream_ptr->ch_stream);
                           ...
                           /*unget_char(ch,tstream_ptr->ch_stream);*/ //Fault version3 -JUNE
                           break;
                 ...
                 case 30 :  /* This is COMMENT case */
                           ...
                           //token_ind=next_st=0;
                           next_st=0;   // Fault Version 5 - June
                           break;
            }
            cu_state=next_st;
            ch=get_char(tstream_ptr->ch_stream);
...
int token_ind;
{
	    ...
	    {
		if(token_ind >= 10) break; /* Added protection - hf */ //Fault Version 7 80 -> 10 change -JUNE
